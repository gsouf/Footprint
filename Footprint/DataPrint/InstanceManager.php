...
class InstanceManager {
    ...
    function __construct(DataPrintCollection $dataPrint) {
     ...
     *  according to the dataprint (identified by dataprint instance,
     *  or by its internalPrint generated by dataprint of $this)
     * 
